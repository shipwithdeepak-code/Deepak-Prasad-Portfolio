          ...
          <div className="max-w-[1440px] w-full mx-auto px-6 lg:px-[96px] relative z-10 flex flex-col items-center">
            <div className="max-w-[1248px] w-full flex flex-col items-center">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#E4F2EB] border border-[#128E5F]/10 mb-[30px]"
              >
                <Sparkles className="w-3.5 h-3.5 text-[#128E5F]" />
                <span className="text-[#128E5F] text-[13px] font-sans font-medium uppercase tracking-wider">Built for serious money</span>
              </motion.div>
