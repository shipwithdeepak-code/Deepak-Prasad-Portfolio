...
export default function Integration01Finsyc({ className }: { className?: string }) {
  ...
  return (
    <>
      ...
      <section className={"w-full bg-[#F4FBFA] py-16 md:py-[100px] overflow-hidden relative flex justify-center " + (className || "")}>
          ...
          <div className="w-full max-w-[1248px] mx-auto">
            ...
            <div className="flex flex-col items-center text-center mb-12 md:mb-[80px]">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#128E5F]/5 border border-[#128E5F]/10 mb-6"
              >
                <Star className="w-4 h-4 text-[#128E5F] fill-[#128E5F]" />
                <span className="text-[#128E5F] text-[14px] font-medium font-sans">Integrations</span>
              </motion.div>
              ...
              <motion.h2
                ...
                viewport={{ once: true }}
                className="text-[32px] sm:text-[40px] md:text-[52px] font-semibold text-[#042619] leading-[1.2] md:leading-[58px] tracking-tight md:tracking-[-1.8px] mb-6 max-w-2xl text-center"
              >
              ...
              <motion.p
                ...
                viewport={{ once: true }}
                className="text-[15px] md:text-[18px] text-[#042619] leading-[1.6] md:leading-[28px] max-w-[612px] font-sans font-normal opacity-80 text-center"
              >
              ...
              >
                <defs>
                  <linearGradient id="line-gradient-left" x1="0%" y1="0%" x2="100%" y2="0%">
                    <stop offset="0%" stopColor="#128E5F" stopOpacity="0.02" />
                    <stop offset="100%" stopColor="#128E5F" stopOpacity="0.4" />
                  </linearGradient>
                  ...
                  return (
                    <React.Fragment key={"path-left-" + i}>
                      <path
                        ...
                        opacity="0.9"
                      />
                      <motion.circle r="3.5" fill="#128E5F">
                        <animateMotion
                          dur="3.5s"
                  ...
                  {leftIntegrations.map((item, idx) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col">
                        <span className="text-[#042619] font-semibold text-[14px] lg:text-[16px] leading-tight">{item.name}</span>
                        <span className="text-[#042619]/40 text-[12px] lg:text-[13px] font-sans mt-0.5">{item.description}</span>
                      </div>
                    </motion.div>
                  ))}
                </div>
                ...
                <div className="flex items-center justify-center py-8 lg:py-0 lg:absolute lg:left-1/2 lg:top-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2">
                  <div className="relative w-[100px] lg:w-[124px] h-[100px] lg:h-[124px] flex items-center justify-center">
                    <motion.div
                      ...
                      className="absolute inset-0 -m-8 lg:-m-[58px] rounded-full bg-[#E5F2EB]/60 shadow-[inset_0_0_40px_rgba(19,142,95,0.03)]"
                    />
                    ...
                    >
                      <div className="w-[84px] lg:w-[104px] h-[84px] lg:h-[104px] rounded-full bg-[#FAFEFC] flex items-center justify-center">
                        <img
            ...
            <div className="flex flex-col items-center mt-12 md:mt-[80px] gap-6 md:gap-8">
              <motion.div
                ...
                viewport={{ once: true }}
                className="inline-flex items-center gap-3 px-5 md:px-[24px] py-2 md:py-[11px] rounded-full border border-[#128E5F]/15 bg-white/50 shadow-[0_4px_24px_rgba(19,142,95,0.03)]"
              >
                <ShieldCheck className="w-5 h-5 text-[#128E5F]" />
                <p className="text-[13px] md:text-[15px] font-sans">
                  <span className="text-[#128E5F] font-semibold">Bank-level security.</span>{" "}
                  <span className="text-[#042619]/40">Your data is encrypted and never shared.</span>
                </p>
              </motion.div>
              ...
              <motion.p
                ...
                viewport={{ once: true }}
                className="text-[13px] md:text-[15px] text-[#042619]/40 font-sans tracking-tight text-center px-4"
              >
                Trusted by{" "}
                <span className="font-semibold text-[#128E5F]">100,000+</span>{" "}
                users. Connect with{" "}
                <span className="font-semibold text-[#128E5F]">10,000+</span>{" "}
