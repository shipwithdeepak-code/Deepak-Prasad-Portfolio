...
function BenefitItem({ title, description, icon: Icon, delay = 0 }: BenefitItemProps) {
  return (
    ...
    >
      <div className="flex-shrink-0 w-10 h-10 bg-[#f8fbfa] border border-[#F8F8FD] rounded-lg flex items-center justify-center">
        <Icon className="w-5 h-5 text-[#128E5F]" strokeWidth={2.5} />
      </div>
      <div className="flex flex-col gap-1">
        <h3 className="text-[#052619] font-onest text-[20px] md:text-[24px] font-semibold leading-[26px] md:leading-[30px] tracking-[-0.6px] md:tracking-[-0.8px]">
          {title}
        </h3>
        <p className="text-[#052619] font-sans text-base md:text-[18px] font-normal leading-[24px] md:leading-[28px] opacity-80">
          {description}
        </p>
      </div>
    </motion.div>
            ...
            <div className="flex flex-col lg:flex-row items-start gap-16 lg:gap-[48px] justify-between">
              ...
              <div className="w-full lg:max-w-[622px] flex flex-col items-start lg:sticky lg:top-[120px] self-start">
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="px-4 py-2 bg-[#F2FAF6] border border-[#128E5F]/15 rounded-full flex items-center gap-2 mb-8"
                >
                  <Sparkles className="w-4 h-4 text-[#128E5F] fill-[#128E5F]" />
                  <span className="text-[#128E5F] font-sans text-sm font-medium">Benefits</span>
                </motion.div>
                ...
                <motion.h2
                  ...
                  className="text-[#052619] font-onest text-[32px] sm:text-[42px] md:text-[52px] font-semibold leading-[38px] sm:leading-[48px] md:leading-[58px] tracking-[-1.2px] md:tracking-[-1.8px] mb-3"
                >
                ...
                <motion.p
                  ...
                  className="text-[#052619] font-sans text-lg md:text-[20px] font-normal leading-[24px] md:leading-[30px] opacity-80 mb-16 max-w-[560px]"
                >
                ...
                <div className="flex flex-wrap gap-3">
                  {tags.map((tag: string, idx: number) => (
                    <motion.span
                      ...
                      className="px-6 py-3 border border-[#052619]/10 rounded-full text-[#052619] font-sans text-[16px] md:text-[18px] font-normal hover:bg-[#F6FCFF] transition-colors cursor-default"
                    >
                      {tag}
                    </motion.span>
                  ))}
              ...
              <div ref={containerRef} className="flex-1 lg:max-w-[578px] flex items-start pr-0 lg:h-[300vh] h-auto relative w-full">
                <div className="lg:sticky lg:top-[120px] lg:h-[800px] h-auto flex items-start w-full lg:overflow-hidden overflow-visible">
                  ...
                  <div className="hidden lg:flex flex-col items-center mr-10 xl:mr-12 relative w-[2px] bg-[#128E5F]/10 self-stretch">
                    <motion.div
                      style={{ scaleY, originY: 0 }}
                      className="w-full bg-[#128E5F] absolute top-0 left-0 h-full"
                    />
                  </div>
