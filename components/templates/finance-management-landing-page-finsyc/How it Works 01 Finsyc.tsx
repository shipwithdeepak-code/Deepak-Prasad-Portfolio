...
export default function FinsycOriginal4step({ className }: { className?: string }) {
  ...
  return (
    <>
      ...
      <section className={"w-full bg-[#F6FDFE] py-20 lg:py-32 overflow-hidden " + (className || "")}>
          ...
          <div className="flex flex-col items-start gap-12 lg:gap-16">
            ...
            <div className="flex flex-col items-start">
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#188E39]/10 bg-[#188E39]/5 whitespace-nowrap mb-6"
              >
                <Sparkles className="w-4 h-4 text-[#188E39]" strokeWidth={2.5} />
                <span className="text-[#188E39] text-center font-inter text-base font-normal leading-6 tracking-[-0.3px]">
                  Process
                </span>
              </motion.div>
              ...
              <motion.h2
                ...
                className="text-[#042619] font-onest text-[32px] sm:text-[44px] lg:text-[52px] font-semibold leading-tight lg:leading-[58px] tracking-[-1.2px] lg:tracking-[-1.8px] w-full lg:max-w-[556px] text-left"
              >
            ...
            <div className="w-full flex flex-col gap-6">
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          isActive ? "bg-white" : "hover:bg-[#F6FDFE]"
                        )}
                      >
                        <step.icon
                          className={cn("w-[22px] h-[22px]", isActive ? "text-[#188E39]" : "text-[#042619]/60")}
                          strokeWidth={2.5}
                        />
                        <span className={cn(
                          "font-inter text-base sm:text-[18px] leading-[28px] whitespace-nowrap",
                          isActive ? "text-[#188E39] font-medium" : "text-[#042619]/60 font-normal"
                        )}>
                          {step.label}
                        </span>
                      </button>
              ...
              {/* Main Content Card */}
              <div className="w-full">
                <div className="w-full bg-white rounded-[32px] border border-[#042619]/[0.04] shadow-[0_0_20px_0_rgba(4,39,24,0.04)] flex flex-col lg:flex-row items-center justify-between p-6 lg:pt-4 lg:pr-4 lg:pb-4 lg:pl-16 gap-12 lg:gap-0 overflow-hidden">
                  ...
                  <div className="w-full lg:w-[534px] flex flex-col items-start text-left">
                    <motion.div
                      ...
                      className="w-16 h-16 rounded-xl border border-[#042619]/10 bg-white shadow-sm flex items-center justify-center p-4 mb-3"
                    >
                      <activeStep.icon className="w-8 h-8 text-[#188E39]" strokeWidth={2.5} />
                    </motion.div>
                    ...
                    <motion.h3
                      ...
                      transition={{ duration: 0.3 }}
                      className="text-[#042619] font-onest text-[28px] lg:text-[34px] font-semibold leading-tight lg:leading-[38px] tracking-[-1px] mb-4"
                    >
                      {activeStep.heading}
                    </motion.h3>
                    ...
                    <motion.p
                      ...
                      className="text-[#042619] font-inter text-base lg:text-[18px] font-normal leading-relaxed lg:leading-[28px] opacity-80 mb-8"
                    >
                    ...
                    <div className="flex flex-col gap-3 mb-12">
                      {activeStep.list.map((item: string, i: number) => (
                        ...
                        >
                          <div className="w-5 h-5 rounded-full bg-[#188E39]/10 flex items-center justify-center shrink-0">
                            <Check className="w-3 h-3 text-[#188E39] stroke-[3px]" />
                          </div>
                          <span className="text-[#042619] font-inter text-base font-medium leading-6 tracking-[-0.3px]">
                            {item}
                          </span>
                        </motion.div>
                      ))}
                    ...
                    <motion.button
                      ...
                      layout
                      className={cn(
                        "flex items-center gap-3 py-2 rounded-full bg-[#042619] group cursor-pointer relative h-14 transition-all duration-300",
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <ArrowUpRight className="w-4 h-4 text-[#042619]" />
                        </motion.div>
                      </motion.div>
                    </motion.button>
                  </div>
