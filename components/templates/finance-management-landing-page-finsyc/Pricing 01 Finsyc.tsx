              ...
              <li key={idx} className="flex items-start gap-3">
                ...
                >
                  <Check
                    size={14}
                    strokeWidth={3.5}
                    className={isVisualActive ? "text-[#042718]" : "text-[#14803D]"}
                  />
                </div>
                <span
...
export default function Pricing01Finsyc({ className }: { className?: string }) {
  ...
  return (
    <>
      ...
      <section
        id="pricing"
        className={"w-full bg-[#fffeff] py-20 lg:py-32 overflow-hidden flex justify-center " + (className || "")}
      >
        <div className="w-full max-w-[1248px] lg:px-0 px-6 flex flex-col items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#E4F2EC] border border-[#042718]/08"
          >
            <Sparkles size={14} strokeWidth={3} className="text-[#14803D]" />
            <span className="font-inter text-sm font-medium text-[#14803D]">Pricing Plan</span>
          </motion.div>
          ...
          >
            ...
            >
              Yearly
              <span className="px-2 py-0.5 rounded-full bg-[#22C45F] text-[10px] text-white font-bold whitespace-nowrap">
                Save 23%
              </span>
            </button>
          </motion.div>
