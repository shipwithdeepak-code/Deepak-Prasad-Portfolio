...
export default function MetricsWithLogo01Finsyc({ className }: { className?: string }) {
  ...
  return (
    <>
      <section
        className={"w-full bg-[#F6FCFF] py-20 lg:py-32 flex justify-center " + (className || "")}
      >
          ...
          <div className="w-full max-w-[1248px] mx-auto">
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-end mb-10 md:mb-[64px] gap-8">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="flex items-center h-[56px] min-w-fit w-max bg-[#042718] rounded-full group cursor-pointer transition-colors duration-300 hover:bg-[#063a25] overflow-hidden gap-[12px]"
              >
                <motion.div
                  layout="position" 
