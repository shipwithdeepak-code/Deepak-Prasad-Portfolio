  ...
  return (
    <>
      ...
      <div className={"flex flex-col w-full " + (className || "")}>
        {/* Metrics Section */}
        <section className="w-full bg-[#F6FCFF] py-16 lg:pt-32 lg:pb-16 overflow-hidden flex justify-center">
          <div className="w-full max-w-[1248px] px-6 lg:px-0 flex flex-col items-center">
            <motion.div
              initial={{ y: 10, opacity: 0 }}
              whileInView={{ y: 0, opacity: 1 }}
              viewport={{ once: true }}
              className="flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#E4F2ED] border border-[#042718]/[0.08]"
            >
        ...
        {/* Testimonial Section */}
        <section className="w-full bg-[#F6FCFF] py-16 lg:pt-16 lg:pb-32 overflow-hidden flex justify-center">
          <div className="w-full max-w-[1440px] flex flex-col items-center overflow-hidden">
            ...
            <div className="w-full max-w-[1248px] px-6 lg:px-0 flex flex-col items-center text-center mt-0 mb-16">
              <div className="inline-flex items-center gap-2 px-3 py-0.5 rounded-full bg-[#128E5F]/[0.05] border border-[#128E5F]/10 mb-4">
                <Star className="w-3.5 h-3.5 text-[#128E5F] fill-[#128E5F]" />
                <span className="text-[14px] font-medium text-[#128E5F] tracking-tight">Testimonials</span>
              </div>
            ...
            <div ref={carouselTrackRef} className="relative w-full overflow-visible">
              ...
              <div className="absolute inset-y-0 left-0 w-[100px] md:w-[180px] z-20 pointer-events-none bg-gradient-to-r from-[#F6FCFF] via-[#F6FCFF]/70 to-transparent" />
              <div className="absolute inset-y-0 right-0 w-[100px] md:w-[180px] z-20 pointer-events-none bg-gradient-to-l from-[#F6FCFF] via-[#F6FCFF]/70 to-transparent" />
            </div>
