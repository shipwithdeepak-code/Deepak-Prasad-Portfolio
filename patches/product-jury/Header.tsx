      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* Subtle Portfolio Backlink */}
            <a
              href="https://deepak-prasad.ai.studio/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium rounded-md text-stone-400 hover:text-amber-300 hover:bg-stone-800/70 border border-transparent hover:border-stone-700/50 transition-colors"
              title="Visit Deepak Prasad's Portfolio"
            >
              <span className="hidden sm:inline">Built by </span>Deepak Prasad
              <span className="text-amber-400 font-semibold text-[11px]">↗</span>
            </a>
          </div>
        </div>
      </div>
